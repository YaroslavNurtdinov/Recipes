...
import com.example.nurtdinov.util.Constants.Companion.PREFERENCES_MEAL_TYPE_ID
import com.example.nurtdinov.util.Constants.Companion.PREFERENCES_NAME
...
class DataStoreRepository @Inject constructor(
    ...
    val readMealAndDietType: Flow<MealAndDietType> = dataStore.data
        ...
        .map { preferences ->
            val selectedMealType = preferences[PreferenceKeys.selectedMealType] ?: "main course"
